...
- Delete the branch for the stage you wish to delete.
  ...
  ```
- Monitor the status of your stage's destruction in the repo's [Actions area](https://github.com/cmsgov/seatool-compare/actions).
...
#### Procedure
- In a browser, go to the [repo](https://github.com/cmsgov/seatool-compare)
